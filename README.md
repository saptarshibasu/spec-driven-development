...
| Universal behavioral guardrails shared across all skills | [`guardrails.md`](docs/guardrails.md) |
| Rules for the agent that executes tasks.md | [`implementation-handoff.md`](docs/implementation-handoff.md) |
