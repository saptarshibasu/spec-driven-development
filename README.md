...
```
<project-root>/
├── AGENTS.md                      # Generated by init-project from templates/agents.template.md — keep short & specific
...
│   │   ├── spec-driven-feature/  ·  clarify/  ·  checklist/  ·  init-project/  ·  amend-constitution/  ·  sync-agents-md/
...
│
├── templates/                     # agents · constitution · spec · plan · tasks · decision-log · checklist
