...
echo ""
echo "  5. Enable the pre-commit hook (computational harness — see docs/hooks.md):"
echo "       git config core.hooksPath .githooks"
echo "     then fill in its lint/test slot with your AGENTS.md commands."
echo ""
echo "  6. (Optional) Connect MCP servers: copy .mcp.json.example to .mcp.json and"
echo "     trim to what you use. Keep it small — see docs/mcp.md."
echo ""
echo "  7. Start your first feature with the spec-driven-feature skill, or:"
echo "     .agents/skills/spec-driven-feature/scripts/start-feature.sh \"<description>\""
echo ""
echo "  8. Commit everything: git add -A && git commit -m \"chore: add SDD structure\""
