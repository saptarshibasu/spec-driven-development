...
prompts — identical text is cache-friendly, and a single source here makes
future edits propagate consistently.
...
byte-identical in every skill for the cache benefit to hold.
